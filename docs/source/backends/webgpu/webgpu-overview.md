...
cmake -B cmake-out-webgpu \
    ...
    -DDawn_DIR=/path/to/dawn/lib/cmake/Dawn
...
WEBGPU_TIMESTAMP_QUERY=1 ./your_runner model.pte
```

Timestamp queries require adapter support and cannot be used with chunked
execution.
